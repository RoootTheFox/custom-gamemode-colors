...
$execute {
	...
	settings->m_cube_override_glow = mod->getSavedValue<int>(CUBE_OVERRIDE_GLOW, 0);
	...
	settings->m_ship_override_glow = mod->getSavedValue<int>(SHIP_OVERRIDE_GLOW, 0);
	...
	settings->m_ball_override_glow = mod->getSavedValue<int>(BALL_OVERRIDE_GLOW, 0);
	...
	settings->m_ufo_override_glow = mod->getSavedValue<int>(UFO_OVERRIDE_GLOW, 0);
	...
	settings->m_wave_override_glow = mod->getSavedValue<int>(WAVE_OVERRIDE_GLOW, 0);
	...
	settings->m_robot_override_glow = mod->getSavedValue<int>(ROBOT_OVERRIDE_GLOW, 0);
	...
	settings->m_spider_override_glow = mod->getSavedValue<int>(SPIDER_OVERRIDE_GLOW, 0);
	...
	settings->m_swing_override_glow = mod->getSavedValue<int>(SWING_OVERRIDE_GLOW, 0);
...
$on_mod(Loaded) {
	...
	settings->m_defaultColorGlow = gameManager->m_playerGlow;
}